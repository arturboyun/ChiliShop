      ...
      <v-card-text>
        <template>
          <v-form v-model="valid" ref="form" lazy-validation>
            ...
            <v-text-field label="User Name" type="username" v-model="username" v-validate="'required'" data-vv-name="username" :error-messages="errors.collect('username')" required></v-text-field>
